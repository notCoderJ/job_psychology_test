...
const PsychologyTest = () => {
  ...
  const handleMovePrev = useCallback(
    () => currentPageIndex > 0 && dispatch(actions.updatePageIndex(-1)),
    [currentPageIndex, dispatch],
  );
  const handleMoveNext = useCallback(
    () =>
      currentPageIndex < lastPageIndex && dispatch(actions.updatePageIndex(1)),
  ...
  const handleSubmit = useCallback(
    (e) => {
      ...
      const sendData = {
        ...
        answers: getResultRequestFormAnswer(
